...
INSERT INTO "MEMBER"
VALUES('MEM3', 'ASDFZXCV', '박철수', '970303-1234567', DEFAULT);

UPDATE "MEMBER"
SET MEMBER_ID = 'MEM03'
WHERE MEMBER_ID = 'MEM3';
...
--> 기본키 중복으로 오류
-- ORA-00001: 무결성 제약 조건(KH_JSW.USER_NO_PK)에 위배됩니다

INSERT INTO USER_USED_PK
VALUES(NULL, 'user03', 'pass03', '유관순', '여', '010-9999-3131', 'yoo123@kh.or.kr');
--> 기본키가 NULL 이므로 오류
-- ORA-01400: NULL을 ("KH_JSW"."USER_USED_PK"."USER_NO") 안에 삽입할 수 없습니다
...
-- ORA-00001: 무결성 제약 조건(KH_JSW.PK_USERNO_USERID)에 위배됩니다
...
-- ORA-01400: NULL을 ("KH_JSW"."USER_USED_PK2"."USER_NO") 안에 삽입할 수 없습니다
...
--> 50이라는 값은 USER_GRADE 테이블 GRADE_CODE 컬럼에서 제공하는 값이 아니므로
 ...
 -- ORA-02291: 무결성 제약조건(KH_JSW.GRADE_CODE_FK1)이 위배되었습니다
 -- 부모 키가 없습니다
...
DELETE FROM USER_GRADE
WHERE GRADE_CODE = 30;
-- 무결성 제약조건(KH_JSW.GRADE_CODE_FK1)이 위배되었습니다
-- 자식 레코드가 발견되었습니다
...
CREATE TABLE USER_TEST(
	USER_NO NUMBER CONSTRAINT USER_TEST_PK PRIMARY KEY,
	USER_ID VARCHAR(20) CONSTRAINT USER_ID_UK UNIQUE,
	USER_PWD VARCHAR(20) CONSTRAINT USER_PWD_NN NOT NULL,
	PNO CHAR(14) CONSTRAINT PNO_UK UNIQUE CONSTRAINT PNO_NN NOT NULL,
	GENDER CHAR(3) CONSTRAINT GENDER_CK CHECK(GENDER IN('남', '여')),
	PHONE VARCHAR(12),
	ADDRESS VARCHAR(20),
	STATUS CHAR(1) CONSTRAINT STATUS_NN NOT NULL,
	
	CONSTRAINT STATIS_CK CHECK(STATUS IN('Y','N')) -- 누락된 괄호 추가
);

INSERT INTO USER_TEST
VALUES(1, 'USER01', 'PASS01', '1234-1234', '남', '1234', 'ㅁㄴㅇㄹ', 'Y');
