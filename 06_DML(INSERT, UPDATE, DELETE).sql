...
INSERT INTO EMPLOYEE2 VALUES(900, '장채현', '901123-2345678',
															'jang_ch@kh.or.kr', '01012341234','D1', 'J7',
															'S3', 4300000, 0.2, 200,
															SYSDATE, NULL, 'N');
...
INSERT INTO EMP_01 VALUES(EMP_ID, EMP_NAME, DEPT_TITLE)
SELECT EMP_ID, EMP_NAME, DEPT_TITLE
FROM EMPLOYEE
WHERE DEPT_CODE = 'D1';
...
UPDATE EMPLOYEE2
SET (SALARY, BONUS)
	= (SELECT SALARY, BONUS FROM EMPLOYEE2 e WHERE EMP_NAME = '유재식')
...
SELECT EMP_ID 
FROM EMPLOYEE2 e 
JOIN DEPARTMENT2 d ON(DEPT_CODE = DEPT_ID)
...
SELECT * FROM EMPLOYEE2 e WHERE  EMP_NAME = '장채현';
