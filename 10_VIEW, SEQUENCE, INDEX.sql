...
INSERT INTO TB_TEST VALUES(SEQ_TEST_NO2.NEXTVAL, '홍길동');
INSERT INTO TB_TEST VALUES(SEQ_TEST_NO2.NEXTVAL, '김영희');
INSERT INTO TB_TEST VALUES(SEQ_TEST_NO2.NEXTVAL, '신짱구');

SELECT * FROM TB_TEST;

-- TB_TEST 테이블 UPDATE 시 시퀀스 사용하기

-- TB_TEST에서 TEST_NO 컬럼 값이 가장 작은 컬럼 값을
-- 다음 시퀀스 번호로 변경
UPDATE TB_TEST
SET TEST_NO = SEQ_TEST_NO2.NEXTVAL
WHERE TEST_NO = (SELECT MIN(TEST_NO) FROM TB_TEST); 

SELECT * FROM TB_TEST; -- 100 -> 115 으로 변경
...
-- SEQ_TEST_NO 시퀀스의 최대값을 200으로 변경
...
SELECT * FROM EMPLOYEE; -- 인덱스 사용 X  0.005

SELECT * FROM EMPLOYEE -- 인덱스 사용 O  0.002
WHERE EMP_ID != 0; 
...
WHERE TEST_ID  = 'TEST500000'; -- 0.016
