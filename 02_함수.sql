...
SELECT 1234, TO_CHAR(1234) FROM DUAL; -- 데이터 타입이 변견됨
...
-- 50 이상
SELECT 
	TO_DATE('77-11-25', 'YY-MM-DD') "YY",
	TO_DATE('77-11-25', 'RR-MM-DD') "RR"
FROM DUAL;
...
SELECT EMP_ID, EMP_NAME, NVL2(PHONE,  RPAD(SUBSTR(PHONE,1,3), LENGTH(PHONE) , '*'), '없음') 전화번호
